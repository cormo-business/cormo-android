...
class PickmeMainViewModel : ViewModel() {
    ...
    private var _delegate: Int = PickmeHandLandmarkerHelper.DELEGATE_CPU
    private var _minHandDetectionConfidence: Float =
        PickmeHandLandmarkerHelper.DEFAULT_HAND_DETECTION_CONFIDENCE
    private var _minHandTrackingConfidence: Float = PickmeHandLandmarkerHelper
        .DEFAULT_HAND_TRACKING_CONFIDENCE
    private var _minHandPresenceConfidence: Float = PickmeHandLandmarkerHelper
        .DEFAULT_HAND_PRESENCE_CONFIDENCE
    private var _maxHands: Int = PickmeHandLandmarkerHelper.DEFAULT_NUM_HANDS
